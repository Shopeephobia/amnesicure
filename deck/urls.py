...
from deck.views import deck_index, create_deck, fetch_public_deck, fetch_requests, fetch_request_private, create_request, verify_request, reject_request
...
urlpatterns = [
    ...
    path('public', fetch_public_deck, name='fetch_public_deck'),
    path('requests', fetch_request_private, name='fetch_request_private'),
